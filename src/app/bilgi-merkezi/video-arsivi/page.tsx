...
export default function VideoArsivi() {
  ...
  const videos = [
    {
      title: t("video.v1.title"),
      description: t("video.v1.desc"),
      duration: "4:32",
    },
    {
      title: t("video.v2.title"),
      description: t("video.v2.desc"),
      duration: "6:15",
    },
    {
      title: t("video.v3.title"),
      description: t("video.v3.desc"),
      duration: "3:48",
    },
  ];
      ...
      <div className="min-h-screen bg-white pt-12">
        <div style={{ paddingTop: "32px", paddingLeft: "20px" }}>
          <Link href="/" className="inline-flex items-center gap-2 text-[#86868b] hover:text-[#dc2626] transition-colors">
            ...
            <span className="text-base font-medium">{t("video.back")}</span>
          </Link>
        </div>

        <div style={{ padding: "32px 20px 0" }}>
          <p style={{ fontSize: "12px", fontWeight: 600, color: "#dc2626", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: "14px" }}>{t("video.label")}</p>
          <h1 style={{ fontSize: "32px", fontWeight: 700, color: "#1d1d1f", lineHeight: 1.15, marginBottom: "12px" }}>{t("video.title")}</h1>
            ...
            {videos.map((video, i) => (
              <div key={i} style={{ cursor: "pointer" }} className="group">
                <div style={{ aspectRatio: "16/9", background: "#1d1d1f", position: "relative", overflow: "hidden", marginBottom: "14px" }}>
                  ...
                  <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "56px", height: "56px", border: "2px solid rgba(255,255,255,0.3)", display: "flex", alignItems: "center", justifyContent: "center" }}>
    ...
    <div className="min-h-screen bg-white pt-12">
      <div style={{ paddingTop: "80px", paddingLeft: "200px" }}>
        <Link href="/" className="inline-flex items-center gap-2 text-[#86868b] hover:text-[#dc2626] transition-colors">
          ...
          <span className="text-lg font-medium">{t("video.back")}</span>
        </Link>
      </div>

      <div style={{ padding: "80px 200px 0" }}>
        <p style={{ fontSize: "14px", fontWeight: 600, color: "#dc2626", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: "20px" }}>{t("video.label")}</p>
        <h1 style={{ fontSize: "56px", fontWeight: 700, color: "#1d1d1f", lineHeight: 1.1, marginBottom: "16px" }}>{t("video.title")}</h1>
          ...
          {videos.map((video, i) => (
            <div key={i} style={{ cursor: "pointer" }} className="group">
              <div style={{ aspectRatio: "16/9", background: "#1d1d1f", position: "relative", overflow: "hidden", marginBottom: "20px" }}>
                ...
                <div className="group-hover:!bg-[#dc2626]" style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "72px", height: "72px", border: "2px solid rgba(255,255,255,0.3)", display: "flex", alignItems: "center", justifyContent: "center", transition: "all 0.3s" }}>
