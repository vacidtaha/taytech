...
function SmartEndustriyelInner() {
  const { t } = useLanguage();
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] pt-12">
      ...
      <section className="bg-[#f5f5f7]" style={{ paddingTop: "60px", paddingBottom: "40px" }}>
        <h1 className={`text-[#86868b] ${isMobile ? "text-2xl" : "text-5xl"} font-medium text-center`}>{t("mega.prod.smartEnd")}</h1>
      </section>
