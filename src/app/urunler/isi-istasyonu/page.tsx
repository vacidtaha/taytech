...
const kategoriler = [
  { id: 1, baslikKey: "prod.isi.direct.title", resim: "/direct.jpg", link: "/urunler/isi-istasyonu/direct" },
  { id: 2, baslikKey: "prod.isi.indirect.title", resim: "/indirect.jpg", link: "/urunler/isi-istasyonu/indirect" },
];
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] pt-12">
      <section className="bg-[#f5f5f7]" style={{ paddingTop: "180px", paddingBottom: "60px" }}>
        <h1 className="text-[#86868b] text-5xl font-medium text-center">{t("urunler.isi.title")}</h1>
      </section>
