...
const kategoriler = [
  {
    id: 1,
    baslik: "Doğrudan Yol Verme",
    resim: "/dogrudan-yol-verme.png",
    link: "/urunler/akilli-kontrol-panolari/elektromekanik/dogrudan-yol-verme"
  },
  {
    id: 2,
    baslik: "Yıldız / Üçgen Yol Verme",
    resim: "/yildiz-ucgen-yol-verme-em.png",
    link: "/urunler/akilli-kontrol-panolari/elektromekanik/yildiz-ucgen"
  }
];
    ...
    <div className="min-h-screen bg-[#f5f5f7] pt-12">
      ...
      <section className="bg-[#f5f5f7]" style={{ paddingTop: "60px", paddingBottom: "60px" }}>
        <h1 className="text-[#86868b] text-5xl font-medium text-center">
          Elektromekanik Kontrol Panoları
        </h1>
      </section>
