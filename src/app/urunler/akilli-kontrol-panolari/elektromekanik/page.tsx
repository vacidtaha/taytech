...
const kategoriler = [
  { id: 1, baslikKey: "mega.prod.dogrudan", resim: "/dogrudan-yol-verme.png", link: "/urunler/akilli-kontrol-panolari/elektromekanik/dogrudan-yol-verme" },
  { id: 2, baslikKey: "mega.prod.yildizUcgenEM", resim: "/yildiz-ucgen-yol-verme-em.png", link: "/urunler/akilli-kontrol-panolari/elektromekanik/yildiz-ucgen" },
];

export default function ElektromekanikKontrolPanolari() {
  const { t } = useLanguage();
    ...
    return (
      <div className="min-h-screen bg-[#f5f5f7] pt-12">
        ...
        <section className="bg-[#f5f5f7]" style={{ paddingTop: "32px", paddingBottom: "24px" }}>
          <h1 style={{ fontSize: "28px", fontWeight: 500, color: "#86868b", textAlign: "center" }}>{t("mega.prod.elektromekanikPano")}</h1>
        </section>
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] pt-12">
      ...
      <section className="bg-[#f5f5f7]" style={{ paddingTop: "60px", paddingBottom: "60px" }}>
        <h1 className="text-[#86868b] text-5xl font-medium text-center">{t("mega.prod.elektromekanikPano")}</h1>
      </section>
