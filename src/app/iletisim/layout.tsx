...
export const metadata: Metadata = {
  title: "İletişim",
  description: "Taytech ile iletişime geçin. Gebze, Kocaeli merkezli ofisimiz ve fabrikamıza ulaşın. Teklif, teknik destek ve iş birliği için bize yazın. Tel: +90 262 644 05 61",
