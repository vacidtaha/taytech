    ...
    return (
      <div className="min-h-screen bg-white pt-12">
        ...
        <div style={{ padding: "32px 20px 0" }}>
          ...
          <h1 style={{ fontSize: "28px", fontWeight: 700, color: "#1d1d1f", lineHeight: 1.15, marginBottom: "16px" }}>{t("cozumler.hastane")}</h1>
          <p style={{ fontSize: "16px", color: "#86868b", fontWeight: 450, lineHeight: 1.6 }}>{t("cozumler.hastaneDesc")}</p>
        </div>
        <div style={{ margin: "28px 20px", height: "1px", background: "#e5e5e5" }} />
        <div style={{ padding: "0 20px 32px" }}>
          <div>
            <h2 style={{ fontSize: "24px", fontWeight: 600, color: "#1d1d1f", marginBottom: "16px", lineHeight: 1.2 }}>{t("cozumler.hastane.h2")}</h2>
            <p style={{ fontSize: "15px", color: "#424245", lineHeight: 1.8, marginBottom: "16px" }}>{t("cozumler.hastane.p1")}</p>
            <p style={{ fontSize: "15px", color: "#424245", lineHeight: 1.8, marginBottom: "24px" }}>{t("cozumler.hastane.p2")}</p>
          </div>
          <div>
