    ...
    return (
      <div className="min-h-screen bg-white pt-12">
        ...
        <div style={{ padding: "32px 20px 0" }}>
          ...
          <h1 style={{ fontSize: "28px", fontWeight: 700, color: "#1d1d1f", lineHeight: 1.15, marginBottom: "16px" }}>{t("cozumler.saha")}</h1>
          <p style={{ fontSize: "16px", color: "#86868b", fontWeight: 450, lineHeight: 1.6 }}>{t("cozumler.sahaDesc")}</p>
        </div>
        <div style={{ margin: "28px 20px", height: "1px", background: "#e5e5e5" }} />
        <div style={{ padding: "0 20px 32px" }}>
          <div>
            <h2 style={{ fontSize: "24px", fontWeight: 600, color: "#1d1d1f", marginBottom: "16px", lineHeight: 1.2 }}>{t("cozumler.saha.h2")}</h2>
            <p style={{ fontSize: "15px", color: "#424245", lineHeight: 1.8, marginBottom: "16px" }}>{t("cozumler.saha.p1")}</p>
            <p style={{ fontSize: "15px", color: "#424245", lineHeight: 1.8, marginBottom: "24px" }}>{t("cozumler.saha.p2")}</p>
          </div>
          <div>
  ...
  return (
    <div className="min-h-screen bg-white pt-12">
      ...
      <div style={{ padding: "80px 200px 0" }}>
        ...
        <h1 style={{ fontSize: "56px", fontWeight: 700, color: "#1d1d1f", lineHeight: 1.1, marginBottom: "24px" }}>{t("cozumler.saha")}</h1>
        <p style={{ fontSize: "20px", color: "#86868b", fontWeight: 450, maxWidth: "640px", lineHeight: 1.6 }}>{t("cozumler.sahaDesc")}</p>
      </div>
      <div style={{ margin: "60px 200px", height: "1px", background: "#e5e5e5" }} />
      <div style={{ padding: "0 200px 40px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px" }}>
          <div>
            <h2 style={{ fontSize: "32px", fontWeight: 600, color: "#1d1d1f", marginBottom: "24px", lineHeight: 1.2 }}>{t("cozumler.saha.h2")}</h2>
            <p style={{ fontSize: "17px", color: "#424245", lineHeight: 1.8, marginBottom: "24px" }}>{t("cozumler.saha.p1")}</p>
            <p style={{ fontSize: "17px", color: "#424245", lineHeight: 1.8 }}>{t("cozumler.saha.p2")}</p>
          </div>
          <div>
